...
<?php if(isset($_GET["action"]) && $_GET["action"] == "edit") : ?>
    ...
    <form action="?p=user-admin&action=edit&id=<?= $app->content["user_edit"]->getId()  ?>&save#edit" method="post" id="edit">

        <div class="input-field col s12">
            <i class="material-icons prefix">account_circle</i>
            <input id="icon_prefix" name="update[username]" value="<?= $app->content["user_edit"]->getUsername() ?>" data-success="right" type="text" class="validate">
            <label for="icon_prefix">Username</label>
            <?= (\app\classes\Notice::get("username") > '') ?  "<p class='red-text'>" . \app\classes\Notice::get("username") . "</p>" : ""?>
        </div>
        <div class="input-field col s12">
            <i class="material-icons prefix">account_circle</i>
            <input id="icon_prefix" name="update[email]" value="<?= $app->content["user_edit"]->getEmail() ?>" type="text" class="validate">
        ...
        <div class="input-field col s12">
            ...
            <input id="icon_telephone" name="update[role]" value="<?= $app->content["user_edit"]->getRole() ?>" type="text" class="validate">
