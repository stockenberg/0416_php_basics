 ...
 */
foreach (\app\controller\TasksController::getTaskObjectList()["assigned"] as $row => $taskObj) : $nextName = $taskObj->getUserName() ?>

    <?php if((isset($lastName) && $lastName != $nextName) || !isset($lastName)) : ?>
...
<?php $lastName = $taskObj->getUserName(); endforeach; ?>